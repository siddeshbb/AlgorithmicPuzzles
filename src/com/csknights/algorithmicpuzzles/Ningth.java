...
public class Ningth extends Activity {
	private TextView[] t3=new TextView[12];
	private TextView[] t4=new TextView[13];
	private Button bt2,bt3;
	private Object[] ob2=new Object[12];
	private Object[] ob3=new Object[12];
	private int i=0;
	private int k=0;
	private String[] s6=new String[12];
	private String[] s7=new String[12];
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		t3[11]=(TextView)findViewById(R.id.t1);
		calltime(4,5000);
		calltime(0,5600);
		calltime(1,6200);
		calltime(2,6800);
		...
		t4[5]=(TextView)findViewById(R.id.tex15);
		t4[6]=(TextView)findViewById(R.id.text13);
		t4[7]=(TextView)findViewById(R.id.text14);
		t4[8]=(TextView)findViewById(R.id.text21);
		t4[9]=(TextView)findViewById(R.id.tex);
		t4[10]=(TextView)findViewById(R.id.te11);
		t4[11]=(TextView)findViewById(R.id.tex14);
		t4[12]=(TextView)findViewById(R.id.text_9);
		...
		t3[11].setOnTouchListener(new ChoiceTouchListener());
		...
		t4[11].setOnDragListener(new ChoiceDragListener());
	...
	private void check(int i) {
		...
		if(((s6[0].equals(s7[0]))&&(s6[1].equals(s7[1])))&&(s6[2].equals(s7[2]))&&(s6[3].equals(s7[3]))&&(s6[4].equals(s7[4]))&&(s6[5].equals(s7[5]))&&(s6[6].equals(s7[6]))&&(s6[7].equals(s7[7])&&(s6[8].equals(s7[8])))&&(s6[9].equals(s7[9]))&&(s6[10].equals(s7[10]))&&(s6[11].equals(s7[11])))
		{
   ...
   public void Met19(View arg0)
   {
	   Intent intent1=new Intent(Ningth.this,Ningth.class);
	   startActivity(intent1); 
   }
   public void Met14(View arg0)
   {
	   Intent intent2=new Intent(Ningth.this,Tenth.class);
	   startActivity(intent2);
   }
	
	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.screen9, menu);
		return true;
	}
}
