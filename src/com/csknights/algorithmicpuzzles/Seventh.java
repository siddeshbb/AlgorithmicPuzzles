...
public class Seventh extends Activity {
	private TextView[] t3=new TextView[10];
	private TextView[] t4=new TextView[11];
	private Button bt2,bt3;
	private Object[] ob2=new Object[10];
	private Object[] ob3=new Object[10];
	private int i=0;
	private int k=0;
	private String[] s6=new String[10];
	private String[] s7=new String[10];
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		t4[10]=(TextView)findViewById(R.id.text_9);
	...
	private void check(int i) {
		...
		if(((s6[0].equals(s7[0]))&&(s6[1].equals(s7[1])))&&(s6[2].equals(s7[2]))&&(s6[3].equals(s7[3]))&&(s6[4].equals(s7[4]))&&(s6[5].equals(s7[5]))&&(s6[6].equals(s7[6]))&&(s6[7].equals(s7[7])&&(s6[8].equals(s7[8])))&&(s6[9].equals(s7[9])))
		{
   ...
   public void Metho12(View arg0)
   {
	   Intent intent1=new Intent(Seventh.this,Seventh.class);
	   startActivity(intent1); 
   }
   public void Metho11(View arg0)
   {
	   Intent intent2=new Intent(Seventh.this,Eigth.class);
	   startActivity(intent2);
   }
	
	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.screen7, menu);
		return true;
	}
}
